...
export function ReviewCard({
  ...
  const reviewUrl = isExternalReview ? review.reviewUrl : undefined;
  ...
  return (
    <article className={`review-card review-card--${source}`}>
      ...
      {/* Footer: Likes, Review Link, etc */}
      {(likes !== undefined && likes > 0) || reviewUrl ? (
        <footer className="review-card__footer">
          ...
          {reviewUrl && (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="review-card__full-review-link"
            >
