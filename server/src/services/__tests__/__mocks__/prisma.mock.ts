...
export function createMockPrismaClient() {
  return {
    ...
    seriesSimilarity: {
      ...
      findUnique: vi.fn().mockResolvedValue(null),
      findFirst: vi.fn().mockResolvedValue(null),
      create: vi.fn().mockImplementation((args) => Promise.resolve({ id: 'sim-1', ...args.data })),
      deleteMany: vi.fn().mockResolvedValue({ count: 0 }),
      count: vi.fn().mockResolvedValue(0),
    },
    recommendationFeedback: {
      ...
      findUnique: vi.fn().mockResolvedValue(null),
      findFirst: vi.fn().mockResolvedValue(null),
      create: vi.fn().mockImplementation((args) => Promise.resolve({ id: 'feedback-1', ...args.data })),
      upsert: vi.fn().mockImplementation((args) => Promise.resolve({ id: 'feedback-1', ...args.create })),
      delete: vi.fn().mockResolvedValue({}),
      deleteMany: vi.fn().mockResolvedValue({ count: 0 }),
      count: vi.fn().mockResolvedValue(0),
    },
